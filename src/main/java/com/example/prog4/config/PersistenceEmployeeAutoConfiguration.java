...
public class PersistenceEmployeeAutoConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean employeeEntityManager(
          @Qualifier("employeeDataSource") final DataSource dataSource
  ) {
    ...
    localContainerEntityManagerFactoryBean.setPackagesToScan("com.example.prog4.repository.employee.entity");
  ...
  public PlatformTransactionManager employeeTransactionManager(
          @Qualifier("employeeEntityManager") final EntityManagerFactory employeeEntityManager
  ) {
